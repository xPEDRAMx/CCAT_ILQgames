...
| Topic in *AmirmohammadKhakpour_Slides.pdf* (footer **N of 36**) | Primary location in this repo |
|----------------------------------------------------------------|--------------------------------|
...
If you use this code or the problem formulation, cite our publication:
